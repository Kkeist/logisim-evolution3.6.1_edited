...
## Logisim-evolution 3.6.1 【Edited version】

**Will logisim be part of my life?**

This edition adds the following features:

1. **File → Preference → Layout → AUTO SAVE**  
   You will not lose your work if Logisim crashes.

2. **Edit → Beautify Wires** (or select wires and press **Ctrl+I**)  
   Removes isolated wires and accidentally added useless wires, and straightens C-shaped wires. Makes the schematic easier on the eyes without changing the actual circuit.

3. **Right-click to DELETE THE ENTIRE WIRE**  
   Delete a whole wire at once when it’s wrong, or select the entire wire and edit it as you like.

4. **Auto rename when you copy & paste**  
   If you copy “SW1”, the pasted instance is automatically renamed to SW2, SW3, … instead of having no label.
