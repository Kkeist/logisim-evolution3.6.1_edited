...
class MenuEdit extends Menu {
  ...
  private final MenuItemImpl beautifyWires = new MenuItemImpl(this, LogisimMenuBar.BEAUTIFY_WIRES);
  ...
  public MenuEdit(LogisimMenuBar menubar) {
    ...
    beautifyWires.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_I, menuMask));
    ...
    menubar.registerItem(LogisimMenuBar.BEAUTIFY_WIRES, beautifyWires);
  ...
  public void localeChanged() {
    ...
    beautifyWires.setText(S.get("editBeautifyWiresItem"));
