...
public class AppPreferences {
  ...
  public static final String AUTO_SAVE_MODE_ON_ACTION = "onAction";
  public static final String AUTO_SAVE_MODE_INTERVAL = "interval";
  public static final PrefMonitor<Boolean> AUTO_SAVE_ENABLED =
      create(new PrefMonitorBoolean("autoSaveEnabled", false));
  public static final PrefMonitor<String> AUTO_SAVE_MODE =
      create(
          new PrefMonitorStringOpts(
              "autoSaveMode",
              new String[] {AUTO_SAVE_MODE_ON_ACTION, AUTO_SAVE_MODE_INTERVAL},
              AUTO_SAVE_MODE_ON_ACTION));
  public static final PrefMonitor<Integer> AUTO_SAVE_INTERVAL_SECONDS =
      create(new PrefMonitorInt("autoSaveIntervalSeconds", 60));
}
